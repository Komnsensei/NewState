...
- [ ] isSubstantive filter on all incoming messages
...
- [ ] /health endpoint returns confidence, gate status, entry count
- [ ] status.cjs dashboard updated with Phase 7 metrics
